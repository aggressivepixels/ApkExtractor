...
public class AppsInfoAdapter extends RecyclerView.Adapter<AppsInfoAdapter.AppViewHolder> implements FastScrollRecyclerView.SectionedAdapter {
    ...
    public AppViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new AppViewHolder(mInflater.inflate(R.layout.item_app, parent, false));
    }
    ...
    public class AppViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public AppViewHolder(View itemView) {
            ...
            sectionHeader = ViewUtils.findViewById(itemView, R.id.app_section_header);
            appIcon = ViewUtils.findViewById(itemView, R.id.app_icon);
            ViewUtils.findViewById(itemView, R.id.app_container).setOnClickListener(this);
        }
